...
var cities = {
	"Amsterdam": [ 52.37, 4.9, false ],
	"Ashdod": [ 31.8, 34.633, true ],
	"Athens": [ 37.984, 23.728, false ],
	...
	"Barcelona": [ 41.383, 2.183, false ],
	"Bogota": [ 4.6, -74.083, false ],
	"Boston": [ 42.333, -71.066, false ],
	"Brussels": [ 50.85, 4.35, false ],
	"Bucharest": [ 44.433, 26.104, false ],
	...
	"Prague": [ 50.083, 14.417, false ],
	"Rio de Janeiro": [ -22.91, -43.196, false ],
	"Rome": [ 41.88, 12.5, false ],
	...
	"São Paulo": [ -23.55, -46.63, false ],
	"Seattle": [ 47.6, -122.333, false ],
	"Stockholm": [ 59.329, 18.069, false ],
	...
	"Vilnius": [ 54.683, 25.283, false ],
	"Warsaw": [ 52.233, 21.017, false ],
	"Wellington": [ -41.29, 174.78, false ],
	"White Plains": [ 41.033, -73.75, false ],
	"Washington DC": [ 38.916, -77, false ],
	"Zurich": [ 47.37, 8.55, false ]
};
