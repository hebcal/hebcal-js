...
var helpString = [
	...
	"Options:\n" + table([
		...
		["",   "--day=DATE", "Print times for the given DAY"],
	...
	"Help subjects: times, cities, warranty, license. Warning: license prints the ENTIRE text of the GPL3; it is very long.",
